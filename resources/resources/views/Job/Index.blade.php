    ...
    <section id="jobDetails">
                <div class="row p-5 justify-center bg-light" >
                    ...
                    <div class="row pt-4">
                            ...
                            @foreach($cats as $cat)
                                @if($cat->cat_root == 0)
                                    <a class="nounderline text-black" href="jobs/cat/{{$cat->id}}"> <h3>{{$cat->cat_name}} </h3></a>
                                    @foreach($cats as $ct)
                                        @if($ct->cat_root == $cat->id)
                                            <div class="fpjobcat m-2" style="max-width: 280px;" onclick="window.location.href = ('jobs/cat/{{$ct->id}}');">
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="card-text" style="font-size: 10pt;"><span style="font-weight: 600">{{App\Models\Job::where('cat_id', '=', $ct->id)->count()}}</span>   job(s)</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class=" mx-auto " style="max-width: 80rem;">
                    <div class="wrapper ">
                        <div class="ocarousel owl-carousel">
                                    ...
                                    <div class="latestjobs" >
                                        <div class="col-sm-12">
                                            <div class="card-body p-3 ">
                                                <div class="row">
                                                    <div class="col-sm-7"><h4 class="card-title">Customer Service Agent</h4></div>
                                                    <div class="col-sm-5 text-align-right jobinfoitem" ><h5><i class="fa fa-user-circle"></i> AWCC Group</h5></div>
                                                </div>
                                                <div class="row card-text bg-light p-1" style="display:flex; flex-direction: row;">
                                                    ...
                                                    <div class="col-sm-3 text-align-center jobinfoitem">
                                                        <i class="fa fa-location-arrow" ></i> Jalal Abad
                                                    </div>
                                                    <div class="col-sm-5 text-align-right jobinfoitem">
                                                        <i class="fa fa-calendar"></i> 22 Aug 2022
                                                    </div>
                            ...
                            <div class="eventcard  w-100" style="max-width: 34rem;">
                                <div class="card-body bg-white">
                                    <div class="latestjobs m-2" style="max-width: 34rem;">
                                        <div class="col-sm-12">
                                            <div class="card-body p-3 ">
                                                <div class="row">
                                                    <div class="col-sm-7"><h4 class="card-title">Assistant Executive</h4></div>
                                                    <div class="col-sm-5 text-align-right jobinfoitem" ><h5><i class="fa fa-user-circle"></i> Real Group</h5></div>
                                                </div>
                                                <div class="row card-text bg-light p-1" style="display:flex; flex-direction: row;">
                                                    <div class="col-sm-4 text-align-left jobinfoitem">
                                                        <i class="fa fa-folder"></i> Industrial
                                ...
                                <div class="card-body bg-white">
                                    <div class="latestjobs m-2" style="max-width: 34rem;">
                                        <div class="col-sm-12">
                                            <div class="card-body p-3 ">
                                                <div class="row">
                                                    <div class="col-sm-7"><h4 class="card-title">Graphic Designer</h4></div>
                                                    <div class="col-sm-5 text-align-right jobinfoitem" ><h5><i class="fa fa-user-circle"></i> Moby Group</h5></div>
                                                </div>
                                                <div class="row card-text bg-light p-1" style="display:flex; flex-direction: row;">
                                                    <div class="col-sm-4 text-align-left jobinfoitem">
                                                        <i class="fa fa-folder"></i> Industrial
                                ...
                                <div class="card-body bg-white">
                                    <div class="latestjobs m-2" style="max-width: 34rem;">
                                        <div class="col-sm-12">
                                            <div class="card-body p-3 ">
                                                <div class="row">
                                                    <div class="col-sm-7"><h4 class="card-title">Data Analyst and Monitoring Officer</h4></div>
                                                    <div class="col-sm-5 text-align-right jobinfoitem" ><h5><i class="fa fa-user-circle"></i> UNICER</h5></div>
                                                </div>
                                                <div class="row card-text bg-light p-1" style="display:flex; flex-direction: row;">
                                                    <div class="col-sm-4 text-align-left jobinfoitem">
                                                        <i class="fa fa-folder"></i> Industrial
