@extends('layouts.app')
@section('header')
    <title>Home .: Tagheer Fundraising</title>
        <!-- Styles -->
        <style>
            body {
        ...
        <div id="carouselExampleCaptions" class="carousel slide " data-bs-ride="carousel">
            ...
            <div class="carousel-inner ">
                <div class="carousel-item active">
                    <img src="{{$slides[0]->sdr_imageURL}}" class="d-block w-100"  alt="...">
                    <div class="carousel-caption-right d-none d-md-block">
                        <h1 style=" color:black;font-size: 35pt; font-family:Segoe UI, Tahoma, Geneva, Verdana, sans-serif;"><strong>{{$slides[0]->sdr_title}}</strong></h1>
                        <h3 style="color: black;">{{$slides[0]->sdr_description}}</h3>
                </div>
                </div>
                <div class="carousel-item">
                    <img src="{{$slides[1]->sdr_imageURL}}" class="d-block w-100" alt="...">
                    <div class="carousel-caption-center d-none d-md-block">
                        <h1 style=" color:white;font-size: 35pt; font-family:Segoe UI, Tahoma, Geneva, Verdana, sans-serif;"><strong>{{$slides[1]->sdr_title}}</strong></h1>
                        <h3 style="color: white;">{{$slides[1]->sdr_description}}</h3>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="{{$slides[2]->sdr_imageURL}}" class="d-block w-100" alt="...">
                    <div class="carousel-caption-left d-none d-md-block">
                        <h1 style=" color:white;font-size: 35pt; font-family:Segoe UI, Tahoma, Geneva, Verdana, sans-serif;"><strong>{{$slides[2]->sdr_title}}</strong></h1>
                        <h3 style="color: white;">{{$slides[2]->sdr_description}}</h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="ea-flip-card-inner">
                        <div class="front">
                            <div class="p-3 ua-flip-card-content text-center position-absolute d-flex align-items-center justify-content-center flex-wrap flex-column">
                             <i class="fa fa-{{$services[0]->svc_ficon}} mb-3" style="color:darkolivegreen; font-size: 40pt"></i>
                                <h3>{{$services[0]->svc_ftitle}}</h3>
                                <p>{{$services[0]->svc_fdescription}}</p>
                            </div>
                        </div>
                        ...
                        <div class="back">
                            <div class="ua-flip-card-content text-center position-absolute d-flex align-items-center justify-content-center flex-wrap flex-column">
                                <h3>{{$services[0]->svc_btitle}}</h3>
                                <p>{{$services[0]->svc_bdescription}}</p>
                                <a class="btn btn-light" href="{{$services[0]->svc_bbtnLink}}">{{$services[0]->svc_bbtncaption}}</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="cause w-100" style="max-width: 25rem;">
                                ...
                                <div class="card-body bg-white">
                                    ...
                                    <div class="row p-3">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-striped progress-bar-animated "  style="width: {{100*$donors->where('cause_id' , '=', $cause->id)->sum('amount')/$cause->cause_goal}}%" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <div class="col-4">
                                            Raised: {{number_format($donors->where('cause_id' , '=', $cause->id)->sum('amount'))}}
                                        </div>
                                        <div class="col-4">
                                            {{number_format($donors->where('cause_id' , '=', $cause->id)->count())}} Donors
                                        </div>
                                        <div class="col-4">
                                    ...
                                    <div class="row justify-center ps-lg-5 pe-lg-5">
                                        <a href="causes/{{$cause->id}}" class="btn btn-dark justify-center ">Donate</a>
                                    </div>
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">@php
                                            $count = \App\Models\categories::where('cat_is_featured' , '=', 1)->count();
                                        echo $count;
                                            @endphp</p>
                                </div>
                            </div>
