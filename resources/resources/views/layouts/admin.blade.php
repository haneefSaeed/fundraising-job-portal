            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Account Settings">Fundraisings</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Authentications">Posted Jobs</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                            <a href="layouts-container.html" class="menu-link">
                                <div data-i18n="Container">Contact Detail</div>
                            </a>
                        </li>

                        <li class="menu-item">
                            <a href="layouts-container.html" class="menu-link">
                                <div data-i18n="Container">Sponsers Detail</div>
                            </a>
                        </li>
                    </ul>
                </li>
