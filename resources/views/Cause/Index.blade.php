                    ...
                    <div class="row p-1">
                        ...
                        <div class="col-md-9" style="display:inline-block;">
                            ...
                            @foreach($causes as $cause)
                                ...
                                <div onclick="window.location.href= '{{route('c.show', $cause->id)}}'" class="blog-container cause-card m-3 " style="">
                                    ...
                                    <div class="blog-body">
                                        ...
                                        <div class="blog-summary pt-3 pb-3" >
                                            <div class=" row pb-2 font-i">
                                                ...
                                                <div class="col-md-4 d-flex justify-items-center" >

                                                    <i class="fa fa-clock-o" style="font-size: 14pt; margin-right: 10px"></i> {{\Carbon\Carbon::parse($cause['cause_start_date'])->diffForHumans()}}
                                                </div>
                                            ...
                                            <p>
                                                {{substr(strip_tags($cause->cause_description),0, 100)}}
                                            </p>
...
a:hover{
    ...
    color: #555;
                                ...
                                @foreach($cats as $cat)
                                    ...
                                    <li style="list-style-type: disc"><a href="#"> {{$cat->cat_name}} ({{App\Models\causes::where('cause_cat_id', '=', $cat->id)->count('cause_cat_id')}})</a></li>
                                        @endif
                                @endforeach
                                </ul>
