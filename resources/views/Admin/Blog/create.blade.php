        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Blog Settings /</span> Blog / Add</h4>

                    <div class="col-xxl">
                        <div class="card mb-4">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">Adding: <strong>New Blog</strong></h5>
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data"  action="{{route('blog.store')}}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="title" class="form-control" id="blog_title" value=""  required/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="tags" class="form-control" id="tags" value="" required/>
                                        </div>
                                    </div>

                                    <input type="hidden" value="{{date("Y/m/d H:i:s")}}" name="created_at" id="created_at">
                                    <input type="hidden" value="{{date("Y/m/d H:i:s")}}" name="publish_date" id="publish_date">
                                    <input type="hidden" value="{{Auth::guard('admin')->user()->id}}" name="user_id" id="user_id">
