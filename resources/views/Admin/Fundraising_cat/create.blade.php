...
<div class="p-4 md:p-6 bg-gray-100 min-h-screen text-gray-900">
    ...
    <!-- Card -->
    <div class="max-w-3xl mx-auto bg-white border border-gray-200 rounded-2xl shadow-sm">

        <!-- Header -->
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h5 class="text-sm md:text-base font-medium">
                Adding:
                <span class="font-semibold text-gray-900">New Category</span>
            </h5>
        </div>
