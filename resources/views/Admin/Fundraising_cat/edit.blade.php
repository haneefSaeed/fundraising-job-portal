        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Fundraising /</span> Category / Edit</h4>

                    <div class="col-xxl">
                        <div class="card mb-4">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">Editing: <strong>{{$cause_cat->cat_name}}</strong></h5>
                                <small class="text-muted float-end">Default label</small>
                            </div>
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data"  action="{{route('fund_cat.update', ['fund_cat' => $cause_cat])}}">
                                    @csrf
                                    @method('PATCH')
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="basic-default-name">Category Name</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="cat_name" class="form-control" id="cat_name" value="{{$cause_cat->cat_name}}" required/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="basic-default-name">Category Icon</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="cat_icon" class="form-control" id="cat_icon" value="{{$cause_cat->cat_icon}}"required />
                                        </div>
                                    </div>
                                    ...
                                    <input type="hidden" value="FR" name="cat_cat" id="cat_cat">
