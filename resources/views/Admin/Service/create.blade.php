        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page Settings /</span> Service / Create</h4>

                    <div class="col-xxl">
                        <div class="card mb-4">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">Adding: <strong>New Service</strong></h5>
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data"  action="{{route('service.store') }}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="svc_ficon" class="form-control" id="service_icon" value="" required/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="basic-default-name">Front Title</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="svc_ftitle" class="form-control" id="service_ftitle" value="" required/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="basic-default-name">Back Title</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="svc_btitle" class="form-control" id="service_btitle" value="" required/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="basic-default-name">Front Descriprion</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="svc_fdescription" class="form-control" id="service_fdescription" value="" required/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="basic-default-name">Back Description</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="svc_bdescription" class="form-control" id="service_bdescription" value="" required/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="basic-default-name">Button Caption</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="svc_bbtncaption" class="form-control" id="service_bbtncaption" value="" required/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="basic-default-name">Button Link</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="svc_bbtnLink" class="form-control" id="service_bbtnLink" value="" required/>
                                        </div>
                                    </div>
