...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/vrbo3yx9zu1wg9krdesifmxdsf1yyey8fnwzu0g2jv69erx8/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
    ...
    <div class="container">
        <section class="wrapper">
            <div class="header-item-left">
                <a href="#" class="brand nounderline"><span style="color: black;">{{$user->web_name}}</span></a>
            </div>
            <!-- Navbar Section -->
    ...
    .mi-font
    {
        ...
        text-transform: uppercase;
                        ...
                        <ul class="menu-section pt-3">
                            ...
                            <li class="menu-item mi-font"><a href="{{route('jobs')}}" class="nounderline">JOBS</a></li>
                            ...
                            <li class="menu-item-has-children mi-font">
                                ...
                                <div class="menu-subs menu-column-1">
                                    <ul>
                                        <li><a href="{{URL::route('j.showcat', [1])}}" class="nounderline">Job Category</a></li>
                                        <li><a href="{{URL::route('c.show', [1])}}" class="nounderline">Single Cause</a></li>
                                        <li><a href="{{URL::route('p.show', [1])}}" class="nounderline">User Profile</a></li>
                                    </ul>
                                </div>
                            </li>
                    ...
                    <ul class="navbar-nav flex-row align-items-center ms-auto mr-2">
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown" style="list-style: none;">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" >
                                ...
                                <li style="list-style: none;">
                                    <a class="dropdown-item" href="{{URL::route('p.show', \Illuminate\Support\Facades\Crypt::encrypt(Auth()->user()->id))}}">
...
{{--                    <li><a href="{{ url('/register') }}">Register</a></li>--}}
                @endauth
                    ...
                    <li class="nav-item navbar-dropdown dropdown-user dropdown" style="list-style: none;">
                        <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                            <div class="avatar ">
                                <button class="btn" href="#" style="background-color : #696cff" >
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a class="dropdown-item" href="{{route("c.create")}}">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                            <h5 style="font-size: 12pt;">Start Fundrising</h5>
                                        </div>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{route('j.create')}}">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                             <h5 style="font-size: 12pt;">Post a Job</h5>
                                        </div>
                                    </div>
                                </a>
                            </li>
        ...
        <div class="row w-75" style="max-width: 80rem; ">
            <div class="col-lg-4">
                ...
                <div class="row">
                    ...
                    <div class="col-10"><h5 class="font-semibold" style="color: white">Address</h5><p style="font-size: 10pt; color: #aaa">{{$user->web_address}}</p></div>
                </div>
                <div class="row">
                    <div class="col-2 p-3"><i class="fa fa-mobile" style="color:darkorange;font-size: 22pt;"></i></div>
                    <div class="col-10"><h5 class="font-semibold" style="color: white">Contact</h5><p style="font-size: 10pt; color: #aaa">{{$user->web_contact}}</p></div>
                </div>
                <div class="row">
                    <div class="col-2 p-3"><i class="fa fa-envelope" style="color:darkorange;font-size: 16pt;"></i></div>
                    <div class="col-10"><h5 class="font-semibold" style="color: white">E-Mail</h5><p style="font-size: 10pt; color: #aaa">{{$user->web_email}}</p></div>
                </div>
            </div>
